...
// Member 'packets'
#include "hesai_lidar/msg/detail/pandar_packet__traits.hpp"
...
[[deprecated("use hesai_lidar::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const hesai_lidar::msg::PandarScan & msg,
  std::ostream & out, size_t indentation = 0)
{
  hesai_lidar::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use hesai_lidar::msg::to_yaml() instead")]]
inline std::string to_yaml(const hesai_lidar::msg::PandarScan & msg)
{
  return hesai_lidar::msg::to_yaml(msg);
}
